export default function News() {
  ...
  <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 text-blue-700 text-center tracking-tight drop-shadow-2xl">회사뉴스</h1>
  <div className="w-full bg-white dark:bg-gray-900/80 rounded-2xl shadow-2xl p-6 mb-8 flex flex-col gap-6 border border-gray-100 dark:border-gray-800 items-center">
    <img src="/images/art-01.jpg" alt="회사뉴스 대표 이미지" className="w-1/2 max-w-xs mb-6 rounded-xl shadow-lg mx-auto" />
          <p className="mb-2 text-base md:text-lg text-gray-700 dark:text-gray-200 font-normal text-center">동해기계의 최신 소식과 뉴스를 안내합니다.</p>
